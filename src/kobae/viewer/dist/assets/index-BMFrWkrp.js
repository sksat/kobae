...
void main() {
	...
	`}var mo=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new fi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    }`,transparent:!1,depthWrite:!0}),au=new ui(Yl,iu);Kl.add(au);var ou=new Dl;ou.domElement.id=`labels`,Wl.parentElement.appendChild(ou.domElement);for(let[e,t]of Object.entries(Pl.landmarks||{})){if(!t)continue;let n=document.createElement(`div`);n.className=`landmark`,n.textContent=e;let r=new xl(n);r.position.set(t[0],t[1],t[2]),Kl.add(r)}function su(){let e=Wl.parentElement.getBoundingClientRect(),t=Math.max(1,Math.round(e.width)),n=Math.max(1,Math.round(e.height));Gl.setSize(t,n,!1),ou.setSize(t,n),Object.assign(ou.domElement.style,{position:`absolute`,left:`0px`,top:`0px`,pointerEvents:`none`}),ql.aspect=t/n,ql.updateProjectionMatrix()}addEventListener(`resize`,()=>{su(),Ju&&Ju.resize()}),su(),ru(`oblique`);var cu=0,lu=0,uu=0,du=0,fu=performance.now(),pu=0,mu=new Float32Array(Pl.superclasses.length),hu=new Float32Array(Pl.readouts.length),gu=new Float32Array(Pl.retina),_u=[],vu=new Map(Pl.readouts.map((e,t)=>[e.index,t])),yu=`readouts`,bu=(location.protocol===`https:`?`wss://`:`ws://`)+location.host+`/ws`,xu;function Su(){xu=new WebSocket(bu),xu.binaryType=`arraybuffer`,xu.onmessage=e=>{if(typeof e.data==`string`){let t=JSON.parse(e.data);t.op===`state`?(Du(t.state,t.paused),t.speed!==void 0&&ku(t.speed)):t.op===`body`&&Qu(t);return}let t=new DataView(e.data),n=t.getUint32(0,!0);if(n===1111641931||n===1346522955){Zu(e.data,t);return}if(n!==Nl)return;cu=t.getFloat32(4,!0),lu=t.getFloat32(8,!0);let r=t.getUint32(12,!0),i=t.getUint32(16,!0),a=t.getUint32(20,!0),o=t.getUint32(24,!0),s=t.getUint32(28,!0),c=t.getFloat32(32,!0),l=36,u=new Uint32Array(e.data,l,i);l+=i*4,mu.set(new Float32Array(e.data,l,a)),l+=a*4,hu.set(new Float32Array(e.data,l,o)),l+=o*4,gu=new Float32Array(e.data,l,s);for(let e=0;e<i;e++){let t=u[e];Zl[t]=cu;let n=vu.get(t);n!==void 0&&_u.push(cu,n)}for(i&&(Vu!==`flight`||performance.now()-pu>100)&&(Ql.needsUpdate=!0,pu=performance.now()),uu=.8*uu+r/Math.max(c,1e-6)*.2;_u.length>6e4;)_u.splice(0,2)},xu.onopen=()=>{for(xu.send(JSON.stringify({op:`body_sub`,value:!0}));Cu.length;)xu.send(JSON.stringify(Cu.shift()))},xu.onclose=()=>setTimeout(Su,1e3)}Su();var Cu=[],wu=e=>{xu&&xu.readyState===1?xu.send(JSON.stringify(e)):Cu.push(e)},Tu={gain:1,sugar:!1,visual:`off`,orn:{},buttons:{},custom:[]};function Eu(e){Object.assign(Tu,e),wu({op:`stim`,patch:e}),Du(Tu)}function Du(e,t){Object.assign(Tu,e),document.querySelectorAll(`[data-toggle]`).forEach(e=>e.classList.toggle(`on`,!!Tu[e.dataset.toggle])),document.querySelectorAll(`[data-visual]`).forEach(e=>e.classList.toggle(`on`,Tu.visual===e.dataset.visual)),document.querySelectorAll(`[data-button]`).forEach(e=>e.classList.toggle(`on`,!!(Tu.buttons||{})[e.dataset.button])),document.querySelectorAll(`[data-orn]`).forEach(e=>e.classList.toggle(`on`,!!(Tu.orn||{})[e.dataset.orn])),$(`#gain`).value=Tu.gain,$(`#gainv`).textContent=Number(Tu.gain).toFixed(2),t!==void 0&&$(`#pause`).classList.toggle(`on`,t)}$(`#gain`).oninput=e=>Eu({gain:+e.target.value});var Ou=[.1,.25,.5,1,2,4,0];function ku(e){$(`#speed`).value=Ou.indexOf(e)>=0?Ou.indexOf(e):3,$(`#speedv`).textContent=e>0?`${e}× 実時間`:`最速`}$(`#speed`).oninput=e=>{let t=Ou[+e.target.value];ku(t),wu({op:`speed`,value:t})},ku(Pl.speed??1),document.querySelectorAll(`[data-toggle]`).forEach(e=>e.onclick=()=>Eu({[e.dataset.toggle]:!Tu[e.dataset.toggle]})),document.querySelectorAll(`[data-visual]`).forEach(e=>e.onclick=()=>Eu({visual:e.dataset.visual}));var Au=!1;$(`#pause`).onclick=()=>{Au=!Au,wu({op:`pause`,value:Au}),$(`#pause`).classList.toggle(`on`,Au)},$(`#reset`).onclick=()=>{wu({op:`reset`}),Zl.fill(-1e9),Ql.needsUpdate=!0,_u.length=0};for(let[e,t]of Object.entries(Pl.buttons)){let n=document.createElement(`button`);n.textContent=Vl[e]||e,n.title=t,n.dataset.button=e,n.onclick=()=>Eu({buttons:{...Tu.buttons,[e]:!(Tu.buttons||{})[e]}}),$(`#buttons`).appendChild(n)}for(let[e,t]of Object.entries(Pl.orn)){let n=document.createElement(`button`);n.textContent=e,n.title=`${t} ORNs`,n.dataset.orn=e,n.onclick=()=>Eu({orn:{...Tu.orn,[e]:!(Tu.orn||{})[e]}}),$(`#orn`).appendChild(n)}$(`#inject`).onclick=async()=>{let e=$(`#glob`).value.trim();if(!e)return;let t=await(await fetch(`/api/search?q=${encodeURIComponent(e)}`)).json();$(`#globinfo`).textContent=`${t.n} cells: `+t.types.slice(0,12).map(e=>`${e.type}×${e.n}`).join(` `),Eu({custom:[...Tu.custom.filter(t=>t.glob!==e),{glob:e,amp:+$(`#amp`).value}]}),t.ids.length&&(vu=new Map(t.ids.slice(0,200).map((e,t)=>[e,t])),yu=e,_u.length=0)},$(`#clear`).onclick=()=>{Eu({custom:[]}),vu=new Map(Pl.readouts.map((e,t)=>[e.index,t])),yu=`readouts`,_u.length=0};var ju=Pl.superclasses.map((e,t)=>{let n=document.createElement(`div`);return n.className=Pl.superclass_counts[t]<100?`bar minor`:`bar`,n.innerHTML=`<span title="${e}: ${Pl.superclass_counts[t]} 細胞" style="color:${Hl[t%Hl.length]}">${zl(e)}</span><div class="track"><div class="fill"></div></div><span class="val"></span>`,$(`#scbars`).appendChild(n),n}),Mu=Pl.readouts.map((e,t)=>t).sort((e,t)=>Object.keys(Bl).indexOf(Pl.readouts[e].type)-Object.keys(Bl).indexOf(Pl.readouts[t].type)||Pl.readouts[e].side.localeCompare(Pl.readouts[t].side)),Nu=Array(Pl.readouts.length);for(let e of Mu){let t=Pl.readouts[e],n=document.createElement(`div`);n.className=`bar`,n.innerHTML=`<span title="${t.type} bodyId ${t.id}">${Bl[t.type]||t.type} ${t.side===`L`?`左`:t.side===`R`?`右`:``}</span><div class="track"><div class="fill"></div></div><span class="val"></span>`,$(`#readouts`).appendChild(n),Nu[e]=n}var Pu=$(`#retina`).getContext(`2d`),Fu=Pl.uv;function Iu(){Pu.fillStyle=`#000`,Pu.fillRect(0,0,240,120);for(let e=0;e<Pl.retina;e++){let t=gu[e]||0;t<=0||(Pu.fillStyle=`rgba(255,230,120,${.25+.75*t})`,Pu.fillRect(Fu[2*e]*238,Fu[2*e+1]*118,2,2))}Pu.strokeStyle=`#2b3648`,Pu.beginPath(),Pu.moveTo(120,0),Pu.lineTo(120,120),Pu.stroke(),Pu.fillStyle=`#8a93a3`,Pu.font=`11px ui-monospace, monospace`,Pu.fillText(`左目`,4,12),Pu.fillText(`右目`,124,12)}var Lu=$(`#raster`).getContext(`2d`);function Ru(){Lu.fillStyle=`#000`,Lu.fillRect(0,0,360,160);let e=2e3,t=cu-e,n=Math.max(1,vu.size);Lu.fillStyle=`#9ad7ff`;for(let r=0;r<_u.length;r+=2){let i=_u[r];i<t||Lu.fillRect((i-t)/e*360,_u[r+1]/n*158,1.5,Math.max(1,158/n-1))}$(`#rasterinfo`).textContent=`${yu===`readouts`?`行動の出力ニューロン`:yu}（${vu.size} 細胞）`}var zu=new K;Wl.addEventListener(`pointerdown`,e=>{Wl._down=[e.clientX,e.clientY]}),Wl.addEventListener(`pointerup`,async e=>{let t=Wl._down;if(!t||Math.hypot(e.clientX-t[0],e.clientY-t[1])>4)return;let n=Wl.getBoundingClientRect(),r=(e.clientX-n.left)/n.width*2-1,i=-((e.clientY-n.top)/n.height)*2+1,a=-1,o=4e-4;for(let e=0;e<Ll;e++){if(zu.set(Fl[3*e],Fl[3*e+1],Fl[3*e+2]).project(ql),zu.z>1)continue;let t=(zu.x-r)**2+((zu.y-i)*n.height/n.width)**2;t<o&&(o=t,a=e)}if(a<0)return;let s=await(await fetch(`/api/cell/${a}`)).json();$(`#cellinfo`).innerHTML=`<b>${s.type||`(型なし)`}</b> ${s.side===`L`?`左`:s.side===`R`?`右`:``} · ${zl(s.superclass)}<br>bodyId ${s.bodyId} · 伝達物質 ${s.nt||`不明`}（${s.sign>0?`興奮性 +`:`抑制性 −`}）<br>出力先 ${s.out_degree} 細胞 · 入力元 ${s.in_degree} 細胞 · いま ${s.rate_hz.toFixed(1)} Hz · 位置は${s.measured_soma?`実測`:`推定`}`,vu=new Map([[a,0]]),yu=s.type||String(a),_u.length=0});var Bu=[],Vu=`flight`,Hu=!1;function Uu(e){Vu=e,e===`flight`&&Xu().then(e=>e.resize()),$(`#flight`).hidden=e!==`flight`,$(`#brainmini`).hidden=e!==`flight`,$(`#bodysec`).hidden=e===`flight`||!Hu,$(`#eyes`).hidden=$(`#minimap`).hidden=!Hu,$(e===`flight`?`#brainminibox`:`#stage`).appendChild(Wl),$(e===`flight`?`#brainmini .sh`:`#stage`).appendChild($(`#views`)),ou.domElement.style.display=e===`flight`?`none`:``,document.querySelectorAll(`[data-mode]`).forEach(t=>t.classList.toggle(`on`,t.dataset.mode===e)),su(),Ju&&Ju.resize()}document.querySelectorAll(`[data-mode]`).forEach(e=>e.onclick=()=>{Uu(e.dataset.mode);try{localStorage.setItem(`kobae.mode`,e.dataset.mode)}catch{}});function Wu(e,t,n,r){let i=e.getContext(`2d`);if(i.fillStyle=`rgba(0,0,0,0.6)`,i.clearRect(0,0,n,r),i.fillRect(0,0,n,r),Bu.length<4)return;let a=1/0,o=-1/0,s=1/0,c=-1/0;for(let e=0;e<Bu.length;e+=2)a=Math.min(a,Bu[e]),o=Math.max(o,Bu[e]),s=Math.min(s,Bu[e+1]),c=Math.max(c,Bu[e+1]);let l=Math.max(o-a,c-s,2),u=(Math.min(n,r)-20)/l,d=(a+o)/2,f=(s+c)/2;i.strokeStyle=`#7cc7ff`,i.beginPath();for(let e=0;e<Bu.length;e+=2){let t=n/2+(Bu[e]-d)*u,a=r/2-(Bu[e+1]-f)*u;e?i.lineTo(t,a):i.moveTo(t,a)}i.stroke();let p=n/2+(t.pos[0]-d)*u,m=r/2-(t.pos[1]-f)*u;i.fillStyle=`#ffe36b`,i.beginPath(),i.arc(p,m,4,0,6.283),i.fill(),t.yaw!==void 0&&(i.strokeStyle=`#ffe36b`,i.beginPath(),i.moveTo(p,m),i.lineTo(p+12*Math.cos(t.yaw),m-12*Math.sin(t.yaw)),i.stroke()),i.fillStyle=`#cfd6e2`,i.font=`10px ui-monospace`,i.fillText(`飛行経路 ${l.toFixed(0)} cm`,6,r-6)}var Gu=null,Ku=null,qu=0,Ju=null,Yu=null;function Xu(){return Yu||=(async()=>(Ju=await Ol($(`#fly`)),document.querySelectorAll(`[data-fview]`).forEach(e=>e.onclick=()=>Ju.views[e.dataset.fview]()),Hu||($(`#flightinfo`).textContent=`体は未接続 · 静止姿勢を表示中（body/ で kobae_body.loop を起動すると飛ぶ）`),Ju.resize(),Ju))()}Uu((()=>{try{return localStorage.getItem(`kobae.mode`)}catch{return null}})()===`brain`?`brain`:`flight`);function Zu(e,t){let n=t.getUint32(0,!0),r=t.getFloat32(4,!0),i=[t.getFloat32(8,!0),t.getFloat32(12,!0),t.getFloat32(16,!0)],a=t.getFloat32(20,!0),o=[t.getFloat32(24,!0),t.getFloat32(28,!0)];if(n===1346522955){let n=t.getUint32(32,!0),s=t.getUint32(36,!0),c=s&268435455,l=s>>>28,u=new Uint16Array(e,40,n),d=new Float32Array(n*7);d.set(new Float32Array(e.slice(40+n*2,40+n*2+n*28))),Xu().then(e=>e.applyPoses(u,d));let f=performance.now();if(f-qu>100){qu=f;let t=new Blob([new Uint8Array(e,40+n*2+n*28,c)],{type:`image/jpeg`});createImageBitmap(t).then(e=>{for(let t of[`eyesbig`,`bodyeyes`]){let n=$(`#`+t);n.width!==e.width&&(n.width=e.width,n.height=e.height),n.getContext(`2d`).drawImage(e,0,0)}e.close()})}Qu({t:r,pos:i,yaw:a,cmd:o,state:[`飛行`,`着地`,`歩行`,`離陸`][l]||``});return}let s=t.getUint32(32,!0),c=t.getUint32(36,!0),l=new Blob([new Uint8Array(e,40,s)],{type:`image/jpeg`}),u=new Blob([new Uint8Array(e,40+s,c)],{type:`image/jpeg`});Gu&&URL.revokeObjectURL(Gu),Ku&&URL.revokeObjectURL(Ku),Gu=URL.createObjectURL(l),Ku=URL.createObjectURL(u),Qu({t:r,pos:i,yaw:a,cmd:o,chaseUrl:Gu,eyesUrl:Ku})}function Qu(e){let t=$(`#bodysec`);if(t.hidden&&=!1,Hu||(Hu=!0,Vu===`flight`&&Uu(`flight`)),e.chaseUrl&&($(`#bodycam`).src=e.chaseUrl),e.eyesUrl,e.pos)for(Bu.push(e.pos[0],e.pos[1]);Bu.length>4e3;)Bu.splice(0,2);if(Wu($(`#bodypath`),e,360,200),Wu($(`#minimap`),e,220,160),e.cmd){let t=`${e.state?e.state+` · `:``}体の時間 ${(e.t??0).toFixed(1)} s · 前進 ${e.cmd[0].toFixed(1)} cm/s · 旋回 ${e.cmd[1].toFixed(2)} rad/s · 高さ ${(e.pos?.[2]??0).toFixed(1)} cm`;$(`#bodyinfo`).textContent=t,$(`#flightinfo`).textContent=t}}var $u=0;function ed(e){if(requestAnimationFrame(ed),!document.hidden&&!(e-$u<33)&&($u=e,Jl.update(),iu.uniforms.uNow.value=cu,Gl.render(Kl,ql),Vu!==`flight`&&ou.render(Kl,ql),Vu===`flight`&&Ju&&Ju.render(),du++,e-fu>500)){$(`#fps`).textContent=Math.round(du*1e3/(e-fu)),du=0,fu=e,$(`#simt`).textContent=(cu/1e3).toFixed(2),$(`#rt`).textContent=lu.toFixed(3),$(`#sps`).textContent=Math.round(uu).toLocaleString();let t=Math.max(1,...mu);ju.forEach((e,n)=>{e.querySelector(`.fill`).style.width=`${100*mu[n]/t}%`,e.querySelector(`.val`).textContent=mu[n].toFixed(2)});let n=Math.max(5,...hu);Nu.forEach((e,t)=>{e.querySelector(`.fill`).style.width=`${100*hu[t]/n}%`,e.querySelector(`.val`).textContent=hu[t].toFixed(1)}),Iu(),Ru()}}requestAnimationFrame(ed);